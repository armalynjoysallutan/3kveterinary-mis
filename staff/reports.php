...
$reportDescriptions = [
    ...
    'pet_records' => 'This report presents the registered pet records of the veterinary clinic, including owner, species, breed, sex, date of birth, registration date, and record status. It is used to review and monitor the clinic\'s patient information.',
